Note: this is my local copy of the training course code and might differ from the original ud615 repo.

You can find the official repo [here](https://github.com/udacity/ud615)
